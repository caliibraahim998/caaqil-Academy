    ...
    <div class="container">
        ...
        <div class="container">
            <div class="card" style="margin-top: 100px;">
                <div class="card-header d-flex justify-content-between items-center bg-success">
                    <h1 class="text-white">Schools List</h1>
                    <!-- Button trigger modal -->
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#schoolsModal">
        ...
        <!-- Modal -->
<div class="modal fade" style="margin-top: 100px;" id="schoolsModal" tabindex="-1" aria-labelledby="schoolsModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="schoolsModalLabel">Teachers Form</h1>
